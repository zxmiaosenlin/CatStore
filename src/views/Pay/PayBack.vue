  ...
  <div class="xtx-pay-page">
    <div class="container">
      ...
      <div class="pay-result">
        ...
        <p class="tip">{{ $route.query.payResult === 'true' ? '我们将尽快为您发货，收货期间请保持手机畅通' : '快去检查哪里出了问题！' }}</p>
        <p>支付方式：<span>支付宝</span></p>
        <p>支付金额：<span>{{ $route.query.payResult === 'true' ? `¥${orderInfo.payMoney?.toFixed(2)}` : '支付失败' }}</span></p>
        <div class="btn">
